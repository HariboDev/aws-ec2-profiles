...
@haribodev/aws-ec2-profiles/1.3.7 win32-x64 node-v12.16.3
$ aep --help [COMMAND]
USAGE
  $ aep COMMAND
...
...
_See code: [src\commands\accounts.js](https://github.com/HariboDev/aws-ec2-profiles/blob/v1.3.7/src\commands\accounts.js)_
...
_See code: [src\commands\configure.js](https://github.com/HariboDev/aws-ec2-profiles/blob/v1.3.7/src\commands\configure.js)_
...
_See code: [src\commands\connect.js](https://github.com/HariboDev/aws-ec2-profiles/blob/v1.3.7/src\commands\connect.js)_
...
_See code: [src\commands\list.js](https://github.com/HariboDev/aws-ec2-profiles/blob/v1.3.7/src\commands\list.js)_
...
_See code: [src\commands\update.js](https://github.com/HariboDev/aws-ec2-profiles/blob/v1.3.7/src\commands\update.js)_
<!-- commandsstop -->
